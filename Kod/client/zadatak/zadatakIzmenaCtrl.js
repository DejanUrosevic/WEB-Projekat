(function(angular) {
	...
	zadatakModule.controller('zadatakIzmenaCtrl', ["$scope", "$stateParams", "$location", "$state", "ZadatakEntry", "ProjekatEntry", function ($scope, $stateParams, $location, $state, ZadatakEntry, ProjekatEntry)
	{
